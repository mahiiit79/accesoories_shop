...
def create_factor_id():
    factor_id = f"fa{str(uuid.uuid1().int >> 64)[:12]}"
    return factor_id


def get_random_payment_id():
    payment_id = f"{str(uuid.uuid1().int >> 64)[:12]}"
    return payment_id
...
class Product(MainModel):
    ...
    tax_percent = models.PositiveIntegerField(default=0, verbose_name=_("tax percent"),
                                              validators=[MaxValueValidator(100)])
    has_value_added_tax = models.BooleanField(default=False, verbose_name=_("has value added tax"))
    meta_keywords = models.CharField(verbose_name=_("keywords"),
                                     help_text=_("separate with comma (used in the site's header for seo)"),
...
class Discount(MainModel):
    ...
    percent = models.PositiveIntegerField(default=0, verbose_name=_("discount percent"),
...
class Cart(MainModel):
    ...
    discount_code = models.ForeignKey(DiscountCode, on_delete=models.CASCADE, verbose_name=_("discount code"),
...
class CartItem(MainModel):
    ...
    product = models.ForeignKey(Product, on_delete=models.CASCADE, verbose_name=_("product"))
    monetary_option = models.ForeignKey(ProductMonetaryOption, on_delete=models.CASCADE,
                                        verbose_name=_("monetary option"), null=True, blank=True)
...
class Setting(MainModel):
    ...
    value_added_tax_percent = models.PositiveIntegerField(default=9, verbose_name=_("value added tax percent"),
                                                          validators=[MaxValueValidator(100), MinValueValidator(1)])
    has_value_added_tax = models.BooleanField(default=True, verbose_name=_("has value added tax"))
    soomasoft_webservice_user = models.CharField(default='', max_length=50,
                                                 verbose_name=_("soomasoft web service user"))
    soomasoft_webservice_password = models.CharField(default='', max_length=50,
                                                     verbose_name=_("soomasoft web service password"))
    soomasoft_webservice_otp_number = models.CharField(default='', max_length=50,
                                                       verbose_name=_("soomasoft otp number"))
...
class Factor(MainModel):
    uuid = models.CharField(max_length=20, default=create_factor_id, verbose_name=_("factor_id"))
    user = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name=_("user"))
    price = models.PositiveIntegerField(default=0, verbose_name=_("price"))
    tax = models.PositiveIntegerField(default=0, verbose_name=_("tax"))
    value_added_tax = models.PositiveBigIntegerField(default=0, verbose_name=_("value added tax"))
    ...
    payment_tracking_code = models.CharField(default="", max_length=255, blank=True, null=True,
                                             verbose_name=_("payment tracking code"))
    ...
    sales_reference_id = models.CharField(_("sales reference ID"), max_length=100, blank=True, null=True)
    res_code = models.BigIntegerField(_("res code ="), blank=True, null=True)
    ...
    shipping_tracking_code = models.CharField(default="", max_length=255, blank=True, null=True,
                                              verbose_name=_("shipping tracking code"))
    ...
    customer_comment = models.CharField(max_length=255, verbose_name=_("name family"), blank=True, null=True)
...
class FactorItem(MainModel):
    ...
    monetary_option = models.CharField(max_length=255, verbose_name=_("monetary option"), blank=True, null=True)
    count = models.PositiveIntegerField(default=1, verbose_name=_("count"), validators=[MinValueValidator(1)])
    price = models.PositiveIntegerField(default=0, verbose_name=_("price"))
...
class SmsVerificcationCode(MainModel):
    sms_verification_uuid = models.CharField(_("Mobile verification uuid"), max_length=40, default=create_uuid)
    mobile = models.CharField(_("Mobile"), max_length=30)
    activation_code = models.PositiveBigIntegerField(_("activation code"))

    class Meta:
        verbose_name = _("SMS verification code")
        verbose_name_plural = _("SMS verification codes")
